...
/// Click an element whose text content matches.
...
/// Capture the page as a base64 PNG using html2canvas loaded dynamically.
/// Falls back to returning the outer HTML if html2canvas fails to load.
